...
class Test_Color_Types extends Unit_Test_Case {
	...
	public function test_is_valid_metadata(): void {
		...
		$invalid_metadata3 = array(
			...
			'modified'    => '2024-12-08',
			'provider'    => 'test',
			'tags'        => array( 'test1', 123 ), // should all be strings
		);
