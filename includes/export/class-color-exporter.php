...
class ColorExporter {
	...
	// Export formats
	private const EXPORT_FORMATS = array(
		'css'    => array( 'variables', 'tailwind', 'sass', 'less' ),
		'design' => array( 'sketch', 'figma', 'adobe_xd', 'invision' ),
		'code'   => array( 'json', 'js', 'ts', 'swift', 'kotlin' ),
		'system' => array( 'android', 'ios', 'flutter', 'react-native' ),
		'web'    => array( 'html', 'svg', 'postcss', 'styled-components' ),
	);
