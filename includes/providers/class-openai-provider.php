...
class OpenAI_Provider extends AI_Provider_Base {
	...
	public function __construct( ?Provider_Config $config = null ) {
		$config        = $config ?? new Provider_Config( array() );
	...
	public function get_requirements(): array {
		return array(
			...
			'model'   => array(
				...
				'default'     => 'gpt-4',
				'options'     => array( 'gpt-4', 'gpt-4-32k', 'gpt-3.5-turbo', 'gpt-3.5-turbo-16k' ),
			),
		);
	}
	...
	public function validate_options( array $options ): bool {
		$valid_options = array( 'model', 'temperature', 'max_tokens', 'top_p', 'frequency_penalty', 'presence_penalty' );
