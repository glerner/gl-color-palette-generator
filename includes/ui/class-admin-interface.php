...
class AdminInterface {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_generate_palette', array( $this, 'handle_generate_palette' ) );
	}
	...
	public function init() {
		...
		add_action( 'wp_ajax_generate_palette', array( $this, 'handle_palette_generation' ) );
		add_action( 'wp_ajax_save_palette', array( $this, 'handle_palette_save' ) );
	}
