...
class Settings_Migrator {
	...
	private static function migrate_to_0_5_0(): void {
		$options = get_option( 'gl_cpg_options', array() );
	...
	private static function migrate_to_1_0_0(): void {
		...
		$int_fields = array( 'cache_duration', 'max_colors', 'default_colors', 'rate_limit' );
		...
		$bool_fields = array( 'enable_analytics', 'debug_mode' );
