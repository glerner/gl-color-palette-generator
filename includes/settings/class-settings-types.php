...
class Settings_Types {
	 ...
	 */
	public const AI_PROVIDERS = array(
		'openai'    => 'OpenAI',
		'anthropic' => 'Anthropic',
		'palm'      => 'PaLM',
		'cohere'    => 'Cohere',
	...
	public static function get_field_definitions(): array {
		return array(
			'ai_provider'      => array(
				...
				'required'    => true,
				'validator'   => array( self::class, 'validate_ai_provider' ),
			),
			'api_key'          => array(
				'type'        => 'password',
				...
				'required'    => true,
				'validator'   => array( self::class, 'validate_api_key' ),
			),
			'cache_duration'   => array(
				'type'        => 'number',
				...
				'max'         => 86400,
				'required'    => true,
				'validator'   => array( self::class, 'validate_cache_duration' ),
			),
			'max_colors'       => array(
				'type'        => 'number',
				...
				'max'         => 20,
				'required'    => true,
				'validator'   => array( self::class, 'validate_max_colors' ),
			),
			'default_colors'   => array(
				'type'        => 'number',
				...
				'max'         => 10,
				'required'    => true,
				'validator'   => array( self::class, 'validate_default_colors' ),
			),
			'enable_analytics' => array(
				'type'        => 'checkbox',
				...
				'required'    => false,
				'validator'   => array( self::class, 'validate_boolean' ),
			),
			'rate_limit'       => array(
				'type'        => 'number',
				...
				'max'         => 100,
				'required'    => true,
				'validator'   => array( self::class, 'validate_rate_limit' ),
			),
			'debug_mode'       => array(
				'type'        => 'checkbox',
