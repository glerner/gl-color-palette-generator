	...
	private function register_routes(): void {
		register_rest_route(
			...
			array(
				...
				'callback'            => array( $this, 'generate_new_palette' ),
				'permission_callback' => array( $this, 'check_generate_permission' ),
				'args'                => array(
					'base_color' => array(
						'required'          => true,
						'type'              => 'string',
						'validate_callback' => array( $this->color_validation, 'is_valid_hex_color' ),
					),
					'scheme'     => array(
						'required' => false,
						'type'     => 'string',
		...
		register_rest_route(
			...
			array(
				array(
					...
					'callback'            => array( $this, 'get_all_palettes' ),
