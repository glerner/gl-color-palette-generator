...
class Color_Types {
	...
	public static function is_valid_metadata( array $metadata ): bool {
		$required_fields = array( 'name', 'description', 'theme', 'created', 'modified', 'provider' );
	...
	public static function is_valid_provider_options( array $options ): bool {
		$allowed_fields = array( 'model', 'temperature', 'max_tokens', 'top_p', 'frequency_penalty', 'presence_penalty' );
		...
		foreach ( $options as $key => $value ) {
			...
			if ( in_array( $key, array( 'temperature', 'top_p', 'frequency_penalty', 'presence_penalty' ), true ) ) {
