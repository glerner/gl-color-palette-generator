...
class Color_Utility implements \GL_Color_Palette_Generator\Interfaces\Color_Utility {
	 ...
	 * }
	 */
	public function convert_colors( array $colors, string $from, string $to, array $options = array() ): array {
		$converted = array();
	 ...
	 */
	public function format_colors( array $colors, string $format, array $options = array() ): array {
		$formatted = array();
