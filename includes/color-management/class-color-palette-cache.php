 ...
 */
class Color_Palette_Cache implements \GL_Color_Palette_Generator\Interfaces\Color_Palette_Cache {
    /**
     * Cache group name
     */
    const CACHE_GROUP = 'gl_color_palette_generator';
