 ...
 * @since   1.0.0
 */
interface Color_Palette_Search {
	/**
	 ...
	 * }
	 */
	public function find_similar( string $palette_id, array $options = array() ): array;
	 ...
	 * }
	 */
	public function index( array $palette, array $options = array() ): array;
}
