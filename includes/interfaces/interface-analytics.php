...
interface Analytics {
	 ...
	 */
	public function track_usage( string $feature, array $context = array() ): void;
	 ...
	 * }
	 */
	public function generate_report( array $criteria = array() ): array;
	 ...
	 */
	public function export_analytics( string $format, array $options = array() ): string;
}
