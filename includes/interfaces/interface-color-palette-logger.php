...
interface Color_Palette_Logger {
	 ...
	 * }
	 */
	public function get_logs( array $criteria = array() ): array;
	 ...
	 * }
	 */
	public function analyze_logs( array $options = array() ): array;
	 ...
	 * }
	 */
	public function maintain_logs( string $action, array $params = array() ): array;
}
