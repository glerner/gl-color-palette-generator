...
interface Color_Palette_Renderer_Interface {
	 ...
	 */
	public function render_palette( Color_Palette $palette, string $format = 'html', array $options = array() ): string;
	 ...
	 */
	public function render_swatch( string $color, string $format = 'html', array $options = array() ): string;
	 ...
	 */
	public function render_color_info( string $color, array $options = array() ): string;
