 ...
 * @since   1.0.0
 */
interface Color_Palette_History {
	/**
	 ...
	 * }
	 */
	public function record_version( array $palette, array $options = array() ): array;
	 ...
	 * }
	 */
	public function get_history( int $palette_id, array $options = array() ): array;
	 ...
	 * }
	 */
	public function restore_version( int $palette_id, int $version_id, array $options = array() ): array;
	 ...
	 * }
	 */
	public function compare_versions( int $palette_id, int $version_1, int $version_2, array $options = array() ): array;
}
