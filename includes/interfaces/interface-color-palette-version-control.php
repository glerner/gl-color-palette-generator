 ...
 * @since   1.0.0
 */
interface Color_Palette_Version_Control {
	/**
	 ...
	 * }
	 */
	public function create_version( array $palette, array $metadata = array() ): array;
	 ...
	 * }
	 */
	public function get_version_history( string $palette_id, array $options = array() ): array;
	 ...
	 * }
	 */
	public function compare_versions( string $version1_id, string $version2_id, array $options = array() ): array;
	 ...
	 * }
	 */
	public function restore_version( string $palette_id, string $version_id, array $options = array() ): array;
}
