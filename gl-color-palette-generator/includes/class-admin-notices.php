...
class GLColorPaletteAdminNotices {
    ...
    public function register_notices() {
        ...
        add_action('wp_ajax_dismiss_palette_notice', [$this, 'handle_notice_dismissal']);
    }
    ...
    public function add_notice($message, $type = 'info', $dismissible = true, $duration = null) {
        ...
        $notices = get_option('color_palette_notices', []);
        $notices[] = $notice;
    ...
    public function display_notices() {
        ...
        $dismissed = get_user_meta($user_id, 'dismissed_palette_notices', true) ?: [];
