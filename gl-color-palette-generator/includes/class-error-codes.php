...
class ErrorCodes {
    ...
    public static function get_message($code) {
        $messages = [
            ...
            self::COLOR_CONVERSION_FAILED => __('Color conversion failed: %s to %s', 'color-palette-generator'),
    ...
    public static function get_severity($code) {
        $severity_ranges = [
            'critical' => [1001, 2001, 3001, 4001, 5001, 6001],
            'error' => [1002, 2002, 3002, 4002, 5002, 6002],
            'warning' => [7001, 7002, 7003, 7004, 7005],
            'notice' => [8001, 8002, 8003, 8004, 8005]
        ];
